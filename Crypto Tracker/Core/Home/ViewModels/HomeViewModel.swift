...
class HomeViewModel: ObservableObject {
    ...
    private func mapGlobalMarketData(dataModel: MarketDataModel?, portfolioCoins: [CoinModel]) -> [StatisticModel] {
        ...
        let marketCap = StatisticModel(title: "Market Cap", value: data.marketCap, percentageChange: dataModel?.marketCapChangePercentage24HUsd)
        ...
        let portfolioPercentage = ((portfolioValue - previousValue) / previousValue) * 100
        
        let portfolio = StatisticModel(
            title: "Portfolio Value",
            value: portfolioValue.asCurrencyWith2Decimales(),
            percentageChange: portfolioPercentage
        )
    ...
    private func mapAllCoinsToPortfolioCoins(allCoins: [CoinModel], portfolioEntities: [PortfolioEntity]) -> [CoinModel] {
        allCoins
            .compactMap { (coin) -> CoinModel? in
                ...
                return coin.updateHolgings(amount: entity.amount)
            }
    }
